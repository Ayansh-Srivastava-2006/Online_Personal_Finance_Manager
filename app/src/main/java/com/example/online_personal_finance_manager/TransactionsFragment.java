...
public class TransactionsFragment extends Fragment {
                            ...
                            public void onResult(Boolean result) {
                                if (getActivity() != null) {
                                    getActivity().runOnUiThread(() -> {
                                        Toast.makeText(getContext(), R.string.transaction_added, Toast.LENGTH_SHORT)
                                                .show();
                                        loadInitialData();
                                    });
                                }
    ...
    private void loadTransactions() {
        FinanceManager.getInstance().getTransactions(new FinanceManager.CustomCallback<List<Transaction>>() {
            ...
            public void onError(Exception e) {
                if (getActivity() != null) {
                    getActivity().runOnUiThread(() -> Toast.makeText(getContext(),
                            getString(R.string.error_loading_transactions, e.getMessage()), Toast.LENGTH_SHORT).show());
                }
            }
        });
    }
    ...
    private void addTransactionRow(Transaction t) {
        ...
        String dateStr = new SimpleDateFormat("MMM dd", Locale.US).format(t.getDate());
