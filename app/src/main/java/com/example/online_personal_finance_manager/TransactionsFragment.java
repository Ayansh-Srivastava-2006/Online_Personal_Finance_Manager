...
public class TransactionsFragment extends Fragment {
    ...
    private void showAddTransactionDialog() {
        ...
        ArrayAdapter<TransactionType> adapter = new ArrayAdapter<>(getContext(), 
        ...
        builder.setView(dialogView)
               .setPositiveButton("Save", (dialog, id) -> {
                   ...
                   if (!amountStr.isEmpty() && !category.isEmpty()) {
                       ...
                       Transaction t = new Transaction(null, amount, type, category, new Date());
                       FinanceManager.getInstance().addTransaction(t, new FinanceManager.Callback<Boolean>() {
                           @Override
    ...
    private void addTransactionRow(Transaction t) {
        ...
        tvAmount.setText(String.format("₹%.2f", t.getAmount()));
